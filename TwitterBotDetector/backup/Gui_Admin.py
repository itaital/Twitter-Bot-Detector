...
import threading
import sys
from ManagerModule import ManagerModule as ManagerModule
...
class Gui_Admin(QWidget):
    ...
    def _initUI(self):
        ...
        main_layout.addWidget(self.graph_frame, 1, 1, 1, 1)
    ...
    def learnPhase(self):
        ...
        if self.btnStartLearnPhase.text() == "Start":
            ...
            self.CNN_model = ManagerModule(train_perc=self.train_percent, batch_size=batch_size, epoch_nbr=epoch_nbr,model_name = model_name)
