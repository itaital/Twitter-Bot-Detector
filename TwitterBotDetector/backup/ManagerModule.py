...
class ManagerModule:
	...
	def __init__(self, train_perc=0.7, batch_size=50, epoch_nbr=10, model_name = 'arcii_first_version_with_two_inputs'):
	...
	def create_model(self,model_name = 'arcii_first_version_with_two_inputs', bots_file_path = 'bots_tweets.txt' , human_file_path = 'human_tweets.txt', test_size_input = 0.3, batch_size=50, epochs=10):
